...
V_CH_A1=0.8/10^3;         % [m^3]    Volume (V_A1) dcv-ocv
V_CH_A=0.8/10^3;        % [m^3]    Constant part of volume (V_A) ocv-cyl
V_CH_B=0.9/10^3;        % [m^3]    Constant part of volume (V_B) cyl-dcv
...
tau_pc= 0.0064*0+0.009;             % [-]       Time constant pc dynamics
